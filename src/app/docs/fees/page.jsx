        ...
        <table className="w-full border-collapse border border-gray-300 mt-10">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 px-4 py-2">5% of the bet amount (in SOL)</td>
            </tr>
            <tr className="bg-gray-800">
            ...
            <tr>
              <td className="border border-gray-300 px-4 py-2">Create a bet market</td>
              <td className="border border-gray-300 px-4 py-2">0 SOL</td>
            </tr>
            <tr className="bg-gray-800">
              <td className="border border-gray-300 px-4 py-2">Withdraw liquidity from a bet market</td>
              <td className="border border-gray-300 px-4 py-2">0.5% of withdrawn amount</td>
            </tr>
          </tbody>
        </table>
        <p className="mt-10">
