class MatchingFunnel {
    constructor(db, config = {}, marketService, statusUpdateService, betUnitService, oddsService, errorService) {
        this.db = db;
        this.config = config;
    ...
    async intakeUnits() {
        ...
        try {
            ...
            this.errorService.createError({
                ...
                ip: "",
                request_data: "",
                source_location: "MATCHING_FUNNEL",
                severity: "SERIOUS",
            });
            throw error;
        }
    ...
    async createMatchAndUpdateMarket(unit1, unit2, matchAmount) {
        ...
        try {
            ...
            this.errorService.createError({
                error_type: 'CREATING_MATCH_FOR_UNITS_ERROR',
                error_message: error.message,
                stack_trace: error.stack || "no stack available",
                wallet_ca: "no wallet available",
                ip: "",
    ...
    async matchUnits(unit1, unit2, statusChanges) {
        ...
        try {
            ...
            this.errorService.createError({
                error_type: 'MATCHING_UNITS_ERROR',
                error_message: error.message,
                stack_trace: error.stack || "no stack available",
                wallet_ca: "no wallet available",
                ip: "",
    ...
    async isMatchingAllowed(bet) {
        ...
        try {
            ...
            this.errorService.createError({
                error_type: 'MATCHING_ELIGIBILITY_ERROR',
                error_message: error.message,
                stack_trace: error.stack || "no stack available",
                wallet_ca: "no wallet available",
                ip: "",
    ...
    async getMatchingStats(timeframe = '24h') {
        try {
            ...
            this.errorService.createError({
                error_type: 'GETTING_MATCHING_STATS_ERROR',
                error_message: error.message,
                stack_trace: error.stack || "no stack available",
                wallet_ca: "no wallet available",
                ip: "",
